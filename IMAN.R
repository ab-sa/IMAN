...
IMAN <- function(ProteinLists, #ProteinList2, ProteinList3, ProteinList4,
                 Species_IDs, #List2_Species_ID, List3_Species_ID,
                 # List4_Species_ID,  
                 identityU, substitutionMatrix, 
                 gapOpening, gapExtension, BestHit = TRUE,
                 coverage, NetworkShrinkage = TRUE,
                 score_threshold, STRINGversion="10",  
  ...
  if (nrow(EdgeList) != 0) {
    ...
    reslist = list(EdgeList = EdgeList , OPS = OPS, 
